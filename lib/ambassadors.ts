export interface Ambassador {
  ...
  advice: string;
  /**
   * Whether THIS PERSON has confirmed the advice above is theirs to publish.
   *
   * The advice text was drafted from their public LinkedIn, not written by
   * them. Everyone here is a real, named, easily-findable person, and a
   * fabricated quote published under their name is the kind of thing that
   * turns a supporter into an ex-supporter. Until they reply confirming (or
   * replacing) it, the card shows a neutral "coming soon" placeholder instead.
   *
   * When someone confirms, flip this one flag to `true` and their words go
...
export const AMBASSADORS: Ambassador[] = [
  {
    ...
    tags: ["National Careers Week", "Green Careers Week", "5,000+ UK Schools", "Careersbox"],
    advice:
      "Don't just think about what job you want. Think about what life you want to live and work backwards from there. The best career is one you'd do even if nobody was watching.",
  ...
  },
  {
    ...
    tags: ["High Performance Podcast", "Bestselling Author", "TEDx Speaker", "250M+ Downloads"],
    advice:
      "I've spoken to hundreds of the world's best performers and not one of them was born with it all figured out. Talent gets you noticed. Consistency is what makes you great.",
    adviceConfirmed: false,
  },
  {
    id: "roei-samuel",
    ...
    bio: [
      ...
      "🚀 Built Connectd from zero to $18M ARR, raised $23M, and been featured in the BBC, Forbes and The Telegraph.",
    ],
    tags: ["Connectd", "Neurodiversity", "ADHD & Dyslexia", "BBC / Forbes"],
    advice:
      "I used to sit in class thinking my brain was broken. It's not. It just works differently. If you feel like you're not good enough, you're wrong. You just haven't found your thing yet.",
    adviceConfirmed: false,
  },
  {
    id: "owen-clater",
    ...
    bio: [
      ...
      "🎤 I'm an international business conference speaker and was recognised as the UK's youngest employer by major media outlets.",
      "🚀 I started young and I'm proof that age is irrelevant when it comes to building, investing and making things happen.",
    ],
    tags: ["Becks & Clates", "Angel Investor", "UK's Youngest Employer", "Tech & AI"],
    advice:
      "I became one of the UK's youngest employers and angel investors not because I had some big advantage, but because I didn't wait. Age is just a number. Back yourself.",
    adviceConfirmed: false,
  },
  {
    ...
    tags: ["BeGreatFitness", "TEDx Speaker", "30 Under 30", "Young Founder"],
    advice:
      "You don't need to be from a big city or have a big following to make a big difference. If you care about something enough, just start. Your community is waiting for you.",
    adviceConfirmed: false,
  },
  {
    id: "chris-ross",
    ...
    bio: [
      ...
      "💡 Before Datumra I helped build a $2bn AI company from the inside, and saw first hand that the biggest thing holding young founders back isn't talent, it's access to the right tools.",
      "🔥 I built Datumra to change that, so the next generation of founders can compete with anyone, no matter where they start.",
    ],
    tags: ["Datumra", "AI & Systems", "Startup Growth", "Founder Tools"],
    advice:
      "You don't need a degree, connections or money to start. You just need to start. The best ideas come from people who don't wait for permission.",
    adviceConfirmed: false,
  },
  {
    id: "tom-mumford",
    ...
    tags: ["In The Business", "ITB Podcast", "500k+ Monthly Views", "Founder Events"],
    advice:
      "I've sat across from hundreds of founders and every single one started with nothing but an idea and the nerve to try. Just start talking to people and put yourself out there.",
    adviceConfirmed: false,
  },
  {
    id: "harrison-turner",
    ...
    tags: ["In The Business", "Step One Podcast", "BBC Radio", "Live Events"],
    advice:
      "Every founder I've interviewed started the same way. No clue, no plan, just a feeling that they wanted to try. That's your step one. You just need to start.",
    adviceConfirmed: false,
  },
  {
    id: "frankie-james",
    ...
    tags: ["Ideas Fest", "The Ideas Community", "GB Entrepreneur Awards", "100k+ Network"],
    advice:
      "The best founders I've met didn't have a perfect plan. They just had the guts to start and the stubbornness to keep going. Show up and back yourself.",
    adviceConfirmed: false,
  },
  {
    id: "myles-shaw",
    ...
    bio: [
      ...
      "🔥 I post a one minute video every single day. No act, no agenda, just real talk about business, family and life.",
    ],
    tags: ["Runrug.com", "The Positive Co.", "School Speaker", "eCommerce"],
    advice:
      "I grew up working in my dad's shop. No big plan, no grand vision. I just kept showing up and kept building. You don't need it all figured out. Just be consistent.",
    adviceConfirmed: false,
  },
  {
    ...
    role: "Product Manager · Ex-eBay, Samsung, Tripadvisor",
    location: "London, United Kingdom",
    region: "London",
    sector: "Tech & AI",
    bio: [
      ...
      "🤖 I now advise early stage startups through Connectd and build AI products on the side.",
    ],
    tags: ["Ex-eBay", "Ex-Samsung", "Ex-Tripadvisor", "Startup Advisor"],
    advice:
      "I started with nothing but curiosity and a willingness to learn. No connections, no shortcuts. Stay curious, keep building, and the opportunities will find you.",
    adviceConfirmed: false,
  },
  {
    id: "sepehr-khosravi",
    ...
    // Not UK-based, so deliberately has no `region` — the UK region filter skips them.
    location: "California, United States",
    sector: "Tech & AI",
    bio: [
      "🤖 I'm Sepehr, Founder of AI Squads, teaching 10,000+ students worldwide how to build with AI. I also teach at UC Berkeley.",
    ...
    tags: ["AI Squads", "UC Berkeley", "10,000+ Students", "AI Education"],
    advice:
      "I flew across the world to meet someone I'd never spoken to because I believed in what I was building. Sometimes the boldest move is the one nobody expects. The worst they can say is no.",
    adviceConfirmed: false,
  },
];
