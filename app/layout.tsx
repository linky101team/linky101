  ...
  return (
    <html lang="en">
      <body className="bg-bg font-sans antialiased lg:flex lg:min-h-screen lg:items-center lg:justify-center lg:gap-12 lg:p-8" style={{ background: "linear-gradient(160deg, #64B5F6, #E1F5FE)" }}>
        ...
        */}
        <div className="mx-auto min-h-screen w-full max-w-[430px] bg-bg lg:min-h-0 lg:h-[min(860px,calc(100vh-4rem))] lg:overflow-y-auto lg:rounded-[40px] lg:border-8 lg:border-white lg:shadow-2xl lg:[transform:translateZ(0)]">
          {children}
        </div>
      </body>
    </html>
